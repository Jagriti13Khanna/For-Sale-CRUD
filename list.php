<?php
            $list_sql = "SELECT ad_id, title, ad, date_posted, user_name, users.u_id, item_sold_yn, deleted_yn, image_name, price FROM for_sale INNER JOIN users ON for_sale.u_id = users.u_id WHERE deleted_yn = 'N' AND item_sold_yn = 'N' $search_part ORDER BY $orderby $order $limit_string";
